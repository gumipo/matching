...
"init": {
      answers: [
      {content: `はじめまして です`, nextId: "first"},
      {content: "Lineおしえて！！", nextId: "firstline"},
      {content: "めっちゃ可愛いですね付き合ってください！！！", nextId: "confession"},
    ],
    girlanswer:"",
  },
"first": {
...
"firstline": {
  answers: [
      ...
      {content: "なら今度食事行かない？良いお店知ってるからどうかな？", nextId: "dinner"},
...
"job": {
  answers: [
    ...
    girlanswer:`私はキャバクラで今バイトしてます。さんは?`
},
"lin": {
  answers: [
      {content: "", nextId: "modal"},
...
"lovehotel": {
  answers: [
      {content: "トイレ巡りでもしませんか？", nextId: "wc"},
  ],
